...
Frame::Frame(const Glib::RefPtr<Gtk::Application>& app)
: 
 m_Box(Gtk::Orientation::VERTICAL)
{
  set_title("NTaks");
  set_default_size(1260, 720);
  ...
  m_refActionGroup->add_action("open",
    sigc::mem_fun(*this, &Frame::on_action_others) );
  ...
  m_refActionGroup->add_action("quit",
    sigc::mem_fun(*this, &Frame::on_action_file_quit) );
...
void Frame::on_action_file_quit()
{
...
void Frame::on_action_others()
{
  std::cout << "A menu item was selected." << std::endl;
}


void Frame::on_action_toggle()
{
